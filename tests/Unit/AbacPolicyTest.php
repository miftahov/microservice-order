...
use App\Models\Abac\Policy;
use App\Models\DTO\AbacPolicyDTO;

class AbacPolicyTest extends TestCase
{
    public function testCorrectAtributes()
    {
        ...
        $policy_value  = $policy_group[0];
        $abac_policy_dto = new AbacPolicyDTO($attributes, $policy_value);
        $policy = new Policy;
        $result = $policy->check($abac_policy_dto);
